...
Route::get('planets/terrain',['\App\Http\Controllers\PlanetAPI','getTerrainDistribution'])->name('get_terrain_distribution');
Route::get('planets/resident',['\App\Http\Controllers\PlanetAPI','getResidentDistribution'])->name('get_resident_distribution');
